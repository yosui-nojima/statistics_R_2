...
```
以下の結果が出力される。\
<img width="1662" alt="スクリーンショット 2023-07-26 13 17 16" src="https://github.com/yosui-nojima/statistics-C1_R_2/assets/85273234/d508d0dc-295e-4ea3-83c6-be31715afb87">
...
- 実行したRのコード
- 実行後の出力結果
- 実行後に出力された図（図の出力方法は、前回実習講義の[図の保存方法](https://github.com/yosui-nojima/statistics-C1_R_1#%E5%9B%B3%E3%81%AE%E4%BF%9D%E5%AD%98%E6%96%B9%E6%B3%95)を参照すること）
...
**※家計調査データは226項目あるため、そこから2つを選ぶ場合<sub>226</sub>C<sub>2</sub>=25,425通りある。**
